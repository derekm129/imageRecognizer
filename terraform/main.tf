...
resource "aws_iam_policy""lambda_ai_services_policy" {
    ...
    policy = jsonencode({
        ...
        Statement = [
            {
                Action = "rekogntion:DetectLabels",
                Effect = "Allow",
                Resource = "*"
            },
            {
...
# This OPTIONS method is still neeed for the browser's preflight request for CORS
...
resource "aws_api_gateway_integration" "options_integration" {
    ...
    # The MOCK integration returns a succes response with the necessary headers.
    request_templates = {
