document.addEventListener('DOMContentLoaded', () => {
    ...
    imageUpload.addEventListener('change', (event) => {
        ...
        if (file) {
            ...
            readerForBase64.onload = (e) => {
                ...
                base64Image = e.target.result.split(',')[1]; p
            };
    ...
    analyzeBtn.addEventListener('click', async () => {
        if (!base64Image || API_ENDPOINT === 'YOUR_API_GATEWAY_INVOKE_URL') {
            alert('Please sekect an image first or configure the API endpoint in script.js');
            return;
        }
        ...
        try {
            ...
            descriptionEl.textContent = `An error ocurred: ${error.message}`;
        } finally {
